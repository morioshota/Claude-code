...
const RARITIES = [
  ...
  { key: 5, label: "UR",  name: "ウルトラレア",     color: "#f0abfc", glow: "0 0 22px rgba(240,171,252,.7)" },
];
...
/* ステージは5段階。レアリティ(N/R/SR/SSR/UR)と1対1で対応し、
   研究レベルが上がるとレアリティも自動で上がる(自分で選ぶ設定は廃止)。
   Lv = 1 + クイックメモ数 + 調査記録数×3 なので、調査記録の目安は
   ST2=1件 / ST3=2〜4件 / ST4=5〜8件 / ST5=9件〜 */
const STAGES = [
  { min: 1,  no: 1, name: "ハッケン",  desc: "見つけたばかり",       iconSize: 32 },
  { min: 4,  no: 2, name: "カンサツ",  desc: "観察がすすんでいる",   iconSize: 40 },
  { min: 8,  no: 3, name: "カイメイ",  desc: "生態がかなり判明",     iconSize: 46 },
  { min: 15, no: 4, name: "マスター",  desc: "生態を知り尽くした",   iconSize: 52 },
  { min: 26, no: 5, name: "デンセツ",  desc: "語り継がれる研究成果", iconSize: 58 },
];
...
const ACHIEVEMENTS = [
  ...
  { id: "stage5",  icon: "🌟", name: "デンセツ調査員",     desc: "1銘柄をステージ5まで育成（調査記録9件〜）" },
...
const SEED = [
  { name: "コムシスHD", code: "1721", market: "東証プライム", type: "build", status: "hold", shares: 633, avgPrice: 3952,
  ...
  { name: "IHI", code: "7013", market: "東証プライム", type: "metal", status: "hold", shares: 100, avgPrice: 2922,
  ...
  { name: "アストロスケールHD", code: "186A", market: "東証グロース", type: "cosmo", status: "hold", shares: 100, avgPrice: 2110,
  ...
  { name: "ピジョン", code: "7956", market: "東証プライム", type: "life", status: "hold", shares: 300, avgPrice: 1724,
    hypothesis: "海外（中国以外）育児市場の開拓で安定成長へ回帰",
    bullets: ["ブランド力・高シェア"], risks: ["中国市場の出生数減少"], triggers: [],
    logs: [{ date: "", text: "保有中（300株 / 平均1,724円）" }] },
  { name: "新日本電工", code: "5563", market: "東証プライム", type: "metal", status: "hold", shares: 400, avgPrice: 391.74,
    hypothesis: "合金鉄・電池材料の需要と市況回復",
    bullets: ["電池材料の将来性"], risks: ["市況（合金鉄価格）依存"], triggers: [],
    logs: [{ date: "", text: "保有中（400株 / 平均391.74円）" }] },
  { name: "ロケットラボ", code: "RKLB", market: "米国 Nasdaq", type: "cosmo", status: "hold", shares: 26, avgPrice: 99.56,
  ...
  { name: "明電舎", code: "6508", market: "東証プライム", type: "spark", status: "watch",
    hypothesis: "電力インフラ更新・データセンター向け変電設備の需要拡大",
    bullets: [], risks: [], triggers: [], logs: [] },
  { name: "任天堂", code: "7974", market: "東証プライム", type: "play", status: "watch",
    hypothesis: "IP資産の多面展開（ゲーム・映像・テーマパーク）で収益基盤が拡大",
    bullets: [], risks: [], triggers: [], logs: [] },
  { name: "トヨタ", code: "7203", market: "東証プライム", type: "drive", status: "watch",
