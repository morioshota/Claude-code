...
const SEED = [
  { name: "コムシスHD", code: "1721", market: "東証プライム", type: "build", rarity: 4, status: "hold", shares: 633, avgPrice: 3952,
  ...
  { name: "IHI", code: "7013", market: "東証プライム", type: "metal", rarity: 3, status: "hold", shares: 100, avgPrice: 2922,
  ...
  { name: "アストロスケールHD", code: "186A", market: "東証グロース", type: "cosmo", rarity: 3, status: "hold", shares: 100, avgPrice: 2110,
  ...
  { name: "ピジョン", code: "7956", market: "東証プライム", type: "life", rarity: 2, status: "hold", shares: 300, avgPrice: 1724,
    hypothesis: "海外（中国以外）育児市場の開拓で安定成長へ回帰",
    bullets: ["ブランド力・高シェア"], risks: ["中国市場の出生数減少"], triggers: [],
    logs: [{ date: "", text: "保有中（300株 / 平均1,724円）" }] },
  { name: "新日本電工", code: "5563", market: "東証プライム", type: "metal", rarity: 2, status: "hold", shares: 400, avgPrice: 391.74,
    hypothesis: "合金鉄・電池材料の需要と市況回復",
    bullets: ["電池材料の将来性"], risks: ["市況（合金鉄価格）依存"], triggers: [],
    logs: [{ date: "", text: "保有中（400株 / 平均391.74円）" }] },
  { name: "ロケットラボ", code: "RKLB", market: "米国 Nasdaq", type: "cosmo", rarity: 4, status: "hold", shares: 26, avgPrice: 99.56,
