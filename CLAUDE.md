...
- **牧場の季節・天気・飾り**: 季節は月(`seasonOf`)、天気は日付ハッシュ(`isRainyToday`・3割)で決まる実時間演出——**株価・市場は一切絡めない**。桜/紅葉/雪のパーティクル、雨は空を鈍色に。すれ違い挨拶(近接ペアに♪・20秒クールダウン)。実績数で飾りが解放(3:花壇 6:かんばん 9:かがり火 全実績:金の像)
